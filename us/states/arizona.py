"""Arizona Revised Statutes — azleg.gov HTML titles."""
...
# ARS cites like "1-101" or "§ 13-105" after Section/Sec./§.
...
class ArizonaRevisedStatutes(Publication):
    """One saved ARS HTML page."""
...
class Arizona(State):
    code = 'US-AZ'
    source = SOURCE
    editions = (ArizonaRevisedStatutes,)
