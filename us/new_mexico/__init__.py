...
SOURCE = 'https://nmonesource.com/'

# Markers like "Section 30-1-1" or "§ 30-1-1" in NMSA HTML.
...
class NewMexicoStatutes(Publication):
    """One saved NMOneSource / NMSA HTML page."""
...
class NewMexico(State):
    code = 'US-NM'
    source = SOURCE
    editions = (NewMexicoStatutes,)

    def list_editions(self):
        return [SOURCE]

    def edition(self, path):
        return NewMexicoStatutes()
